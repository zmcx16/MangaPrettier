...
function Setting() {
  ...
  const renderOutputArgsNode = (outputType) => { return <div>output</div> }
  const [outputArgsNode, setOutputArgsNode] = useState(renderOutputArgsNode(outputTypes.current[0].value))
